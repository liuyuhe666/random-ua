...
var uaMobileList = []func() string{
	generateMobilePixel7UA,
	generateMobilePixel6UA,
	generateMobilePixel5UA,
	generateMobilePixel4UA,
	generateMobileNexus10UA,
}
...
func RandomMobileUserAgent() string {
	return uaMobileList[rand.Intn(len(uaMobileList))]()
}
...
func generateMobilePixel7UA() string {
...
func generateMobilePixel6UA() string {
...
func generateMobilePixel5UA() string {
...
func generateMobilePixel4UA() string {
...
func generateMobileNexus10UA() string {
